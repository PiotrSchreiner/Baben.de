  ...
  return (
    <>
      <button
        ...
        className="group text-white inline-flex p-4 items-center gap-x-3 text-2xl font-semibold leading-3 hover:text-blue-300 relative w-32 h-12 bg-gradient-to-tr from-purple-800 to-blue-500 rounded-md"
      >
      ...
      {isOpen && (
        <div
          ...
          ref={ref}
        >
          <div className="absolute p-6 md:p-12 right-0 space-x-4 md:space-x-10  ">
            <button
              onClick={() => {
                setIsOpen(false);
              }}
            ...
            <div className="col-start-2 col-span-10 ">
              ...
              <div className="relative  cursor-pointer">
                <div className="group relative flex justify-center text-center">
                  <Link href="/">
                    <h1 className="items-center mx-auto justify-center tracking-widest font-extrabold text-7xl text-center text-white lg:my-0 my-10 border-4 border-white rounded-lg p-4">
                      BABEN MEDIA
                    </h1>
                  </Link>
                </div>
          ...
          <div className="flex flex-col justify-around items-center md:flex-2 mt-4 md:mt-20">
            {solutions.map((item) => (
              <Link
                key={item.text}
                href={item.href}
                className="flex justify-center text-center p-6 hover:text-custom-400 font-raleway tracking-widest"
                onClick={() => {
                  setIsOpen(false);
                }}
              >
