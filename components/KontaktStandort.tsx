...
export default function KontaktStandort({
  ...
  const t = useTranslations("KontaktStandort");
  const settings = useMemo(
    () => [
      {
        name: t("rentProperty"),
        description: t("rentOwner"),
        step: "kontakt",
      },
      {
        name: t("tenacyQuestion"),
        description: t("contractQuestion"),
        step: "kontakt",
      },
    ],
    [t]
        ...
        <div className=" relative isolate overflow-hidden px-8 md:pb-14 sm:px-40 my-10">
          <RadioGroup value={selected} onChange={setSelected}>
            <div className="mx-auto max-w-xl text-center mb-8">
              ...
              <p className="text-2xl leading-8 text-white font-semibold tracking-wider">
                {t("whatIsYourRequest")}
              </p>
            </div>
